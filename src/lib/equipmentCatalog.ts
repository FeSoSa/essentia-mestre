...
export const EQUIPMENT_CATALOG: CatalogEntry[] = [
  // Armas — mão principal
  { slot: 'mainHand', item: { id: 'espada-curta',   name: 'Espada Curta',   weaponType: 'sword',  damageBase: 4, damageAttribute: 'strength' } },
  { slot: 'mainHand', item: { id: 'espada-longa',   name: 'Espada Longa',   weaponType: 'sword',  damageBase: 5, damageAttribute: 'strength' } },
  { slot: 'mainHand', item: { id: 'adaga',           name: 'Adaga',          weaponType: 'dagger', damageBase: 4, damageAttribute: 'agility'  } },
  { slot: 'mainHand', item: { id: 'machado',         name: 'Machado',        weaponType: 'axe',    damageBase: 5, damageAttribute: 'strength' } },
  { slot: 'mainHand', item: { id: 'lanca',           name: 'Lança',          weaponType: 'spear',  damageBase: 4, damageAttribute: 'strength' } },
  { slot: 'mainHand', item: { id: 'cajado-arcano',   name: 'Cajado Arcano',  weaponType: 'staff',  damageBase: 5, damageAttribute: 'intelligence' } },
  { slot: 'mainHand', item: { id: 'arco-curto',      name: 'Arco Curto',     weaponType: 'bow',    damageBase: 4, damageAttribute: 'agility'  } },
  { slot: 'mainHand', item: { id: 'arco-longo',      name: 'Arco Longo',     weaponType: 'bow',    damageBase: 5, damageAttribute: 'agility'  } },
  { slot: 'mainHand', item: { id: 'besta',           name: 'Besta',          weaponType: 'bow',    damageBase: 6, damageAttribute: 'agility'  } },
  // Armas — mão secundária / offhand
  { slot: 'offHand', item: { id: 'adaga-off',        name: 'Adaga (off)',    weaponType: 'dagger', damageBase: 4, damageAttribute: 'agility'  } },
  { slot: 'offHand', item: { id: 'escudo-leve',      name: 'Escudo Leve',    weaponType: 'shield', damageBase: 0, damageAttribute: 'strength', attributeBonus: { defense: 1 } } },
  { slot: 'offHand', item: { id: 'escudo-pesado',    name: 'Escudo Pesado',  weaponType: 'shield', damageBase: 0, damageAttribute: 'strength', attributeBonus: { defense: 3 } } },
  // Armaduras
